...
(() => {
  ...
  function chassis() {
    return `<div class="pd-hardware-stage" aria-label="GPU Server 概念示意"><span class="pd-hardware-horizon"></span><img src="/static/img/server-hero.png" alt="金屬 GPU Server 概念示意，非此設備的實際照片" loading="eager" decoding="async"><span class="pd-stage-caption">SERVER / CONCEPT</span></div>`;
  }
