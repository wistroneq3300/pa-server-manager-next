...
(() => {
  ...
  if(window.Chart)Chart.register({id:'paEngineeringReadout',afterUpdate(chart){
    ...
    const text=latest.length?latest.slice(0,4).map(v=>`${v.label}: ${format(v.value)}`).join(' \u00b7 '):'\u5c1a\u7121\u53ef\u7528\u8cc7\u6599';
