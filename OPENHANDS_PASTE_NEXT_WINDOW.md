*** LATEST NEXT UI UPDATE 2026-09-24: Read SESSION_HANDOFF_GB300_INSERTION_20260924.md first, then SESSION_HANDOFF_GB300_RACK_20260924.md. Branch astra-cinematic-ui. Homepage now shares GB300 equipment geometry: same 1U server aligns/inserts into U40, 41 components / 48U / U9-5 covered by a 5U Blanking Panel as finally requested. Operational mixed-U demo is unchanged. Rack labels are Traditional Chinese; multi-U Server top 1U gold, lower extensions gray; no 3D U digits; light NVLink text contrast fixed. Full acceptance 23/23 and geometry 11/11 passed. Preserve upstream functionality; only serve.py uses fixtures. Original repository/main are out of scope. ***
